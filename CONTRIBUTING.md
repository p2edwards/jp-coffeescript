...
tracker](https://github.com/p2edwards/jp-livescript/issues) to report any
...
- jp-LiveScript version. Please, run the command:

```sh
jp-livescript --version
```
...
- Please, open an issue in the [issue
  tracker](https://github.com/p2edwards/jp-livescript/issues).
